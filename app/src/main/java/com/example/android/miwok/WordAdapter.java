...
//*This is a custom Adapter that takes the input a list of  the "word" object.//
...
public class WordAdapter extends ArrayAdapter<Word>{
     ...
     * @param words A List of NumbersActivity objects to display in a list
     */
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        // Get the MiwokTranslation from the currentWord object and
        ...
        // Get the defaultTranslation from the currentWord object and
        // set this text on the Miwok TextView

        EnglishTextView.setText(currentWord.getMiwokTranslation());

        // Find the ImageView in the list_item.xml layout with the ID wordImage.
        ImageView WordImageView = (ImageView) listItemView.findViewById(R.id.wordImage);

        // Get the Image from the currentWord object and
        // set this text on the Word ImageView.
